...
//     try {
//       await axios.post('http://localhost:3000/std/add', {...formData});
...
//     try {
//       const result = await axios.patch('http://localhost:3000/std/update', { id, ...edituser })
//       console.log(result)
...
//   useEffect(() => {
//     if (loggedIn) {
//       getStudents(); // Fetch students only after login
//     }
//   }, [loggedIn]);
...
//                     <td className="thcss">{item.number}</td>
//                     <td className="thcss">
//                       <button
...
const Create = () => {
  ...
  useEffect(() => {
    getStudents(); // Fetch students data when the component mounts
  }, []);
